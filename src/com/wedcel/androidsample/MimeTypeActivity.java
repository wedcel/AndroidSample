...
public class MimeTypeActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mimetype);
	
		imageMimeType = (TextView)findViewById(R.id.imageMimeType);
		testMimeType= (TextView)findViewById(R.id.testMimeType);
		extension = (TextView)findViewById(R.id.extension);
		extension2 = (TextView)findViewById(R.id.extension2);
		
		
		//很SB的mimetype 类似截取 字符串
		...
		String exten = mime.getExtensionFromMimeType("image/gif");
		String exten2 = mime.getExtensionFromMimeType("jpeg");
		
		imageMimeType.setText("imageMimeType:"+type);
		testMimeType.setText("testMimeType:"+testtype);
		extension.setText("ExtensionFromMimeType:"+exten);
		extension2.setText("ExtensionFromMimeType2:"+exten2);
